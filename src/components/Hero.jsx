...
function Hero({ darkMode }) {
  ...
  return (
    <div className="realtive overflow-hidden min-h-screen flex flex-col">
      <section
        id="home"
        data-aos='fade-up'
        data-aos-delat="250"
      ...
      >
            ...
            <div className="w-full pt-4 sm:pt-6 ">
              ...
              >
                ...
                <a href="#contact" className="w-full sm:w-auto">
                  ...
                  >
                    <Mail className="w-4 h4 sm:w-5 sm:h-5 mr-2" />
                    Contact Me
                  </button>
                </a>
              </div>
            ...
            <div className="relative w-4/5 sm:w-3/4 lg:w-full ">
              <div className="relative overflow-hidden">
                <img
                  src={hero}
                  alt="Hero Image"
                  className="w-100 h-auto object-cover transform hover:scale-105 transition-transform duration-500 "
                />
              </div>
              <img
                src={hi}
        ...
        <div className={`absolute -to20 -left-20 `}></div>
      </section>
    </div>
  );
}
