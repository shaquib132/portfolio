...
function Skills({ darkMode }) {
  const skills = [
    ...
    },
    {
      ...
      icon: Java,
      level: 70,
      color: "from-yellow-800 to-blue-900",
    },
    {
      name: "JavaScript",
      icon: javascript,
        ...
        <div className=" container px-5 py-14 mx-auto ">
          <div className="text-center mb-20 " data-aos="fade-up">
            ...
            <p
              ...
              style={{ color: darkMode ? "#d1d5db" : "#4d5563" }}
            >
              Explore the  technologies and tools I use to build modern, 
            ...
            {skills.map((skill, index) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`mt-6 pt-4 border ${darkMode ? "border-gray-700" : "border-gray-300"}`}
                  >
                    <div
