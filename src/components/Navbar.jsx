...
function Navbar({ darkMode, toogleDarkMode }) {
        ...
        <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
          ...
          {isMenuOpen && (
            <motion.div
              ...
              className={`absolute top-full left-0 right-2 mt-2 lg:hidden ${darkMode ? "bg-gray-900/95" : "bg-white/95"} backdrop-blur-lg rounded-xl shadow-lg border ${darkMode ? "border-gray-700 " : "border-gray-200"}`}
            >
              <div>
                {navItem.map((item) => (
                  <a
                  ...
                  >
                    ...
                    >
                      <span
                        className={`font-medium ${activeSection === item.name.toLocaleLowerCase() ? colors.textActive : colors.textSecondary}`}
                      >
                        {item.name}
                      </span>
                    </motion.div>
